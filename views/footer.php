    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mb-4">
                <!--Liens-->
                <h6 class="text-uppercase font-weight-bold">Mes liens</h6>
                <p>
                    <a href="https://www.facebook.com"><i id="iconstyle" class="fab fa-facebook-square fa-3x"></i></a>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <h6 class="text-uppercase font-weight-bold">Mon adresse</h6>
                <p>
                    <i class="fa fa-home mr-3"></i>60400 NOYON, 25, rue Louis Pergaud, France
                </p>
            </div>
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                <h6 class="text-uppercase font-weight-bold">Me contacter</h6>

                <p>
                    <i  class="fa fa-envelope mr-3"></i><a id="mail" href="mailto:contact@Manga-World.com ">contact@Manga-World.com</a>
                </p>
